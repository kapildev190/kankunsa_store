(function ($) {
    ...
    martfury.filterAjax = function () {
        ...
        martfury.$body.on('click', '.mf_widget_product_categories a, .mf-widget-layered-nav a, .widget_rating_filter a, .widget_layered_nav_filters a, ul.woocommerce-ordering a', function (e) {
            e.preventDefault();
