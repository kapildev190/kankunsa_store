...
class Martfury_WCFM {
	...
	function product_meta_save( $new_product_id, $wcfm_products_manage_form_data ) {
		...
		$video_thumbnail_id = ( isset( $wcfm_products_manage_form_data['video_thumbnail'] ) ) ? $wcfm_products_manage_form_data['video_thumbnail'] : '';
		...
		$images_360 = ( isset( $wcfm_products_manage_form_data['product_360_view'] ) ) ? $wcfm_products_manage_form_data['product_360_view'] : '';
		update_post_meta( $new_product_id, 'product_360_view', $images_360 );
	}
	...
	function products_custom_fields( $product_id, $product_type ) {
        ...
        <div class="wcfm-container simple variable external grouped <?php echo apply_filters( 'wcfm_pm_block_custom_class_linked', '' ); ?>">
            <div id="wcfm_products_manage_form_linked_expander" class="wcfm-content">
				...
				$images_360  = ! empty( $images_meta ) ? $images_meta : array();
