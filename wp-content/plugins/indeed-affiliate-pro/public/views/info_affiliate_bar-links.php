...
<div class="uap-ap-field">
  ...
  <select id="uap_affiliate_bar_friendly_links" onChange="uap_info_affiliate_bar_update_link();" class="uap-public-form-control ">
...
<div class="uap-ap-field">
  ...
  <select id="ap_affiliate_bar_ref_type" onChange="uap_info_affiliate_bar_update_link();" class="uap-public-form-control ">
