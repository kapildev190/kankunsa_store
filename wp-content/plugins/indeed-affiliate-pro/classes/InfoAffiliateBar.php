...
class InfoAffiliateBar
{
    ...
    public function output()
    {
        ...
        $data = [
                  ...
                  'generalVisits'           => $statistics->getGeneralVisitsForPermalink(),
                  'generalReferrals'        => $statistics->getGeneralReferralsForPermalink(),
                  'personalVisits'          => $statistics->getPersonalVisitsForPermalink(),
                  'personalReferrals'       => $statistics->getPersonalReferralsForPermalink(),
