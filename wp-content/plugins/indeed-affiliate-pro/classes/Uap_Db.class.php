...
<div><strong>Refuse Referrals :</strong> {refuse_referrals}</div>
				...
				case 'info_affiliate_bar':
					$arr = array(
									...
									'uap_info_affiliate_bar_logo'																=> '',
									'uap_info_affiliate_bar_links_section_enabled'							=> 1,
									'uap_info_affiliate_bar_links_label'												=> __( 'Links', 'uap' ),
		...
		public function is_magic_feat_enable($type=''){
			...
			switch ($type){
				...
				case 'pay_to_become_affiliate':
					...
					break;
				case 'info_affiliate_bar':
					return $temp_data['uap_info_affiliate_bar_enabled'];
					break;
				case 'product_links':
					return $temp_data['uap_product_links_enabled'];
					break;
			}
			return FALSE;
		}
	 ...
	 $return = FALSE;
	          ...
	          $return = TRUE;
	      update_option('uap_envato_code', "NULLED");
	      return $return;
	  }
