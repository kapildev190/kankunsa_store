				...
				<div class="row">
					...
					<div class="uap-form-line">
						...
						<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
							...
							<input type="checkbox" class="uap-switch" onClick="uap_check_and_h(this, '#uap_product_links_enabled');" <?php echo $checked;?> />
					...
					<div class="uap-form-line">
						...
						<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
							...
							<input type="checkbox" class="uap-switch" onClick="uap_check_and_h(this, '#uap_product_links_reward_calculation');" <?php echo $checked;?> />
							<div class="switch" style="display:inline-block;"></div>
						</label>
